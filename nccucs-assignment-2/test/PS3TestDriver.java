...
public class PS3TestDriver {
	...
	private static void printUsage() {
		...
		System.err
    .println("to read from a file: java ps3.GraphTestDriver <name of input script>");
		System.err
    .println("to read from standard in: java ps3.GraphTestDriver");
	}
  
	/** String -> Graph: maps the names of graphs to the actual graph **/
	// TODO for the student: Parameterize the next line correctly.
	// private final Map<String, _______> graphs = new HashMap<String,
	// ________>();
	 ...
	 *
	 * @effects Creates a new PS3TestDriver which reads command from <tt>r</tt>
	...
	private void createGraph(List<String> arguments) {
		if (arguments.size() != 1) {
			throw new CommandException("Bad arguments to CreateGraph: "
                                 + arguments);
		}
	...
	private void createNode(List<String> arguments) {
		if (arguments.size() != 2) {
			throw new CommandException("Bad arguments to createNode: "
                                 + arguments);
		}
	...
	private void listNodes(List<String> arguments) {
		if (arguments.size() != 1) {
			throw new CommandException("Bad arguments to listNodes: "
                                 + arguments);
		}
	...
	private void listChildren(List<String> arguments) {
		if (arguments.size() != 2) {
			throw new CommandException("Bad arguments to listChildren: "
                                 + arguments);
		}
	...
	private void findPath(String graphName, List<String> sourceArgs,
		...
		Set<Path<WeightedNode>> starts = new HashSet<Path<WeightedNode>>();
		...
		DijkstraSpecializer specializer = new DijkstraSpecializer(world);
		Path<WeightedNode> shortest = PathFinder.findPath(specializer, starts,
                                                      goals); // call static method of PathFinder
